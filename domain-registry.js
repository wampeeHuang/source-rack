...
const SECONDARY_REGISTRY = {
  'AI':     ['LLM','Agent','图像生成','视频生成','语音','3D生成','开发平台','学习资源','资讯','代码助手','自动化','未细分'],
  '设计':   ['设计灵感','设计素材','设计工具','室内与家居','建筑与景观','家具与材料','UI/UX','品牌与平面','动效','未细分'],
  '电商':   ['国内电商','跨境电商','选品工具','支付物流','电商服务','电商社区','未细分'],
  '开发工具': ['代码托管','部署平台','API','云服务','知识管理','自动化工具','效率工具','未细分'],
  '内容平台': ['科技资讯','社交平台','内容平台','创作者平台','技术社区','未细分'],
  '商业':   ['众筹','变现','广告','IP版权','招聘','竞品研究','未细分'],
  '知识库': ['学术论文','图书档案','文档手册','教程课程','通用搜索','未细分'],
};
